          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="text-cyan-600 cursor-pointer border p-1.5 rounded-sm backu  hover:text-white hover:bg-cyan-600 text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <i
                  ...
                  {recentJobs.map((job, index) => (
                    ...
                    >
                      <td className="py-3 px-4">
                        <button
                          className="text-cyan-600 hover:text-cyan-800 font-medium cursor-pointer hover:underline"
                          onClick={() =>
                            alert(
